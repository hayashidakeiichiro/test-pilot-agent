...
def attach_find_section_by_context_block(controller: Controller):
    @controller.action("Find section block matching context_block or header_hint")
    async def find_section_by_context_block(
